...
def get_data():
    ...
    # cookie headers хранятся в config.py
    ...
    count_pages = math.ceil(total_items / 24)
    ...
    with open('data/2_products_description.json', 'w') as file:
...
def get_result():
    with open('data/2_products_description.json') as file:
    ...
    for items in products_data.values():
        ...
        for item in products:
            ...
            if product_id in products_prices:
                ...
                item['link'] = f"https://www.mvideo.ru/products/{item.get('nameTranslit')}-{product_id}"
